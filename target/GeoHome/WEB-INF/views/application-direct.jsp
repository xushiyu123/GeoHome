                    ...
                    <div style="width: 100%">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li aria-current="page" class="breadcrumb-item">Applications-direct</li>
                            </ol>
                        </nav>
                    </div>
                    <div class="grid row">
                        <div class="col-md-3 grid-item">
                            <div class="box-masonry">
                                <a title="River Canyon" href="/applications"
                                   class="box-masonry-image with-hover-overlay with-hover-icon">
                                    <img src="<%=request.getContextPath()%>/resources/img/ban1.gif"
                                         alt=""
